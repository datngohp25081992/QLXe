...
Partial Public Class CustomAppointmentForm1
    ...
    Public Overloads Function OnOkButton(ByVal appointment As DevExpress.XtraScheduler.Appointment) As Boolean
        ...
        Return True
    End Function
    Private Sub CustomAppointmentForm1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        lkuNhanVien.Properties.DataSource = (New DataBaseAccess).GetDataTable("Select MaNV,TenNV from tbl_NhanVien")
